  ...
  <nav class="navbar navbar-default">
    <div class="container">
      <div class="navbar-header">
        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#ops-debugger-navbar-collpase">
      ...
      <div class="navbar-collapse collapse" id="ops-debugger-navbar-collpase">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="/signup">注册</a></li>
          <li><a href="/signin">登录</a>
        </ul>
      </div>
    </div>
  </nav>
